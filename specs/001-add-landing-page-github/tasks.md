...
Phase 2: Foundational (blocking prerequisites)
 ...
 - [ ] T006 [P] Add Playwright devDependency, set `test:integration` npm script in `apps/web/package.json`, and run `npx playwright install` to install browsers (depends-on: T001, T001a) (`apps/web/package.json`) — these are the integration tests referenced in the plan.
